...
type UserServiceClient interface {
	...
	GetUser(ctx context.Context, in *GetUserRequest, opts ...grpc.CallOption) (*GetAllUserResponse, error)
...
func (c *userServiceClient) GetUser(ctx context.Context, in *GetUserRequest, opts ...grpc.CallOption) (*GetAllUserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type UserServiceServer interface {
	...
	GetUser(context.Context, *GetUserRequest) (*GetAllUserResponse, error)
...
func (UnimplementedUserServiceServer) GetUser(context.Context, *GetUserRequest) (*GetAllUserResponse, error) {
